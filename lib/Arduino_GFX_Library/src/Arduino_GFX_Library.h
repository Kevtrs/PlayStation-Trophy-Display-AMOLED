...
// Arduino_ESP32RGBPanel retire de ce vendoring (voir NOTICE.md) : son hack
// bas-niveau sur la struct privee esp_rgb_panel_t de l'IDF ne compile pas
// avec la version d'ESP-IDF de ce projet, et cette classe ne sert qu'aux
// panneaux RGB paralleles/MIPI-DSI -- inutilisee ici (bus QSPI uniquement).
...
// Arduino_RGB_Display retire avec Arduino_ESP32RGBPanel, voir NOTICE.md.
