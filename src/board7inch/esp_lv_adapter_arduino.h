// Vendorise tel quel (aucune modification) depuis waveshareteam/ESP32-S3-Touch-LCD-7,
// examples/Arduino/examples/10_lvgl_v9_demo/esp_lv_adapter_arduino.h (recupere le
// 2026-07-28) : porte LVGL 9.5.0 sur ESP32_Display_Panel (tache de l'exemple
// officiel du fabricant) via une tache FreeRTOS dediee + un mutex recursif
// (esp_lv_adapter_lock()/unlock()) -- voir main_7inch.cpp pour l'usage reel
// (AppController/WideUiBridge doivent prendre ce verrou avant tout appel LVGL).
